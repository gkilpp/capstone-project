...
params = {
	...
	"end_date": "2017-08-01",
	"daily": ["temperature_2m_mean", "temperature_2m_max", "temperature_2m_min", "wind_speed_10m_max", "wind_gusts_10m_max", "sunrise", "sunset", "daylight_duration", "sunshine_duration", "precipitation_sum", "rain_sum", "snowfall_sum", "precipitation_hours"],
...
daily_dataframe_vietnam= pd.DataFrame(data = daily_data)
print("\nDaily data\n", daily_dataframe_vietnam)
daily_dataframe_vietnam.to_csv("../data/raw/weather_data_vietnam.csv", index=False)